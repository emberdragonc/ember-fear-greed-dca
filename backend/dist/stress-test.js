...
async function processInBatches(items, batchSize, delayMs, processor, onBatchComplete) {
...
async function getRealWallets() {
    ...
    return (data || []).map(d => ({
        ...
        smartAccountAddress: d.smart_account_address,
    }));
}
function generateSimulatedWallets(realWallets) {
    const simulated = [];
...
// ============================================
async function checkBalancesBatched(wallets) {
    console.log('\n========================================');
...
// ============================================
async function fetchPricesBatched(wallets) {
    console.log('\n========================================');
...
// ============================================
async function fetchSwapQuotesBatched(wallets) {
    console.log('\n========================================');
...
async function testPimlicoBundlerBatched(wallets) {
    console.log('\n========================================');
    ...
    for (let i = 0; i < batches.length; i++) {
        ...
        const requests = batch.map((wallet, idx) => ({
            jsonrpc: '2.0',
