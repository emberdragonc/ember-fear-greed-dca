...
// ============================================
async function fetchSwapQuotesBatched(wallets, batchSize) {
...
// ============================================
async function fetchSwapQuotesParallel(wallets) {
    console.log(`\n========================================`);
...
async function testCoingeckoWithRateLimit() {
    console.log(`\n========================================`);
...
// REPORT GENERATION
// ============================================
function generateReport(batch25, batch50, parallel100, coingecko) {
...
function printFinalReport(report) {
    ...
    let optimal = 'batch25';
    if (batch50Score > batch25Score)
        optimal = 'batch50';
    if (parallelScore > batch50Score)
        optimal = 'parallel100';
    switch (optimal) {
        case 'batch25':
